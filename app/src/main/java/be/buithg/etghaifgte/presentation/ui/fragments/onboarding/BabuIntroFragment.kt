...
import be.buithg.etghaifgte.databinding.FragmentBabuIntroBinding
...
class BabuIntroFragment : Fragment() {

    private lateinit var babuIntroBinding: FragmentBabuIntroBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? {
        babuIntroBinding = FragmentBabuIntroBinding.inflate(inflater, container, false)
        return babuIntroBinding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        activity?.requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
        babuIntroBinding.babuIntroStartButton.setOnClickListener {
